...
protected:
	CSpiderPart_Base(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CSpiderPart_Base(const CSpiderPart_Base& rhs);
	virtual ~CSpiderPart_Base() = default;
...
public:
	static CSpiderPart_Base* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
