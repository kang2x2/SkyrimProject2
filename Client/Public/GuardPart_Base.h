...
class CGuardPart_Base abstract : public CGameObject
{
public:
...
protected:
	CGuardPart_Base(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CGuardPart_Base(const CGuardPart_Base& rhs);
	virtual ~CGuardPart_Base() = default;
...
public:
	static CGuardPart_Base* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
